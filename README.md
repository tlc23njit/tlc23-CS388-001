...
Time spent: **3.5** hours spent in total <!-- Replace 'X' with the number of hours you spent on this project -->
...
My emulator wasn't connecting to my log cat, and it was taking longer than 5 minutes to come online, so I had to search the web for stack overflow pages on how to fix it. 
## Resources
